...
class TestResCurrencyRateProvider(SavepointCase):
    ...
    def test_obtain_rates_nbp_eur(self, *args):
        ...
        self.assertEqual(3, sum(self.currencies.with_company(self.company).mapped('rate')))
        ...
        self.assertEqual(1.0, round(self.currency_eur.with_company(self.company).rate, 4))
        self.assertEqual(1.0642, round(self.currency_usd.with_company(self.company).rate, 4))
        self.assertEqual(4.6925, round(self.currency_pln.with_company(self.company).rate, 4))
    ...
    def test_obtain_rates_nbp_pln(self, *args):
        ...
        # check that currencies were synced properly
        self.assertEqual(0.2131, round(self.currency_eur.with_company(self.company).rate, 4))
        self.assertEqual(0.2268, round(self.currency_usd.with_company(self.company).rate, 4))
        self.assertEqual(1.0, round(self.currency_pln.with_company(self.company).rate, 4))
